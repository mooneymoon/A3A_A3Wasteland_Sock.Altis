...
///////////////////////////////
pvpfw_cleanup_cleanAbandonded = false; // true or false, depending on whether you want abandoned vehicles to be deleted
...
pvpfw_cleanUp_dontCleanUpAround = ["respawn_west","respawn_east","respawn_civilian","respawn_guerrila"]; //do not clean abandoned vehicles around these markers
...
// Clean bodies //
//////////////////
pvpfw_cleanUp_bodyTimer = 1200; // Bodies will be removed after the specified amount of seconds
